...
<body>
    ...
    <div id="date">
		<?php echo JHTML::Date( 'now', '%A, %d.%m.%Y' ); ?> | Valid <a href="http://validator.w3.org/check?uri=referer" target="_blank">XHTML</a> &amp; <a href="http://jigsaw.w3.org/css-validator/check?uri=templates/counterstrike_lernvid.com/css/template.css" target="_blank">CSS</a> | &copy; Designed by <a href="http://www.lernvid.com" target="_blank">LernVid.com</a>
    </div>
